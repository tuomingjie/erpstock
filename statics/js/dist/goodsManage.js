...
function getCustomerData() {
	...
	if (a) {
		var b = {
            ...
            safeDays: $.trim($("#guarantDate").val()),//保质期
            advanceDay: $.trim($("#warnDate").val()),//预警天数
            brandName: $.trim($("#brandName").val()),//商品品牌
